          ...
          <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                {/* Quick Contact */}
                <div className="old-phone-card p-6">
                  <h2 className="old-phone-title text-xl mb-4">Quick Contact</h2>
                  <div className="space-y-3">
                    
                    <a
                      href={mailto(email, "Project Inquiry", "Hello! I'd like to discuss a project with you.")}
                ...
                {/* Response Time */}
                <div className="old-phone-card p-6">
                  <h2 className="old-phone-title text-lg mb-4">Response Time</h2>
                ...
                <div className="old-phone-card p-6">
                  <h2 className="old-phone-title text-lg mb-4">How I Can Help</h2>
            ...
            <div className="mt-12 text-center">
              <div className="old-phone-card p-6 max-w-md mx-auto">
                <h2 className="old-phone-title text-lg mb-4">Connect on Social</h2>
